...
int main(int argc, char **argv) {
    ...
    std::vector<block<double>> loc_blks{
        ...
        {{32, 64 }, {0, 28}, {0, 0}, ptr + 32 + 200 * 100, 200},
        {{64, 96 }, {0, 28}, {0, 0}, ptr + 64 + 200 * 100, 200},
        {{96, 100}, {0, 28}, {0, 0}, ptr + 96 + 200 * 100, 200},

        {{0,  32 }, {28, 60}, {0, 0}, ptr + 0  + 200 * 128, 200},
        {{32, 64 }, {28, 60}, {0, 0}, ptr + 32 + 200 * 128, 200},
        {{64, 96 }, {28, 60}, {0, 0}, ptr + 64 + 200 * 128, 200},
        {{96, 100}, {28, 60}, {0, 0}, ptr + 96 + 200 * 128, 200},

        {{0,  32 }, {60, 92}, {0, 0}, ptr + 0  + 200 * 160, 200},
        {{32, 64 }, {60, 92}, {0, 0}, ptr + 32 + 200 * 160, 200},
        {{64, 96 }, {60, 92}, {0, 0}, ptr + 64 + 200 * 160, 200},
        {{96, 100}, {60, 92}, {0, 0}, ptr + 96 + 200 * 160, 200},

        {{0,  32 }, {92, 100}, {0, 0}, ptr + 0  + 200 * 192, 200},
        {{32, 64 }, {92, 100}, {0, 0}, ptr + 32 + 200 * 192, 200},
        {{64, 96 }, {92, 100}, {0, 0}, ptr + 64 + 200 * 192, 200},
        {{96, 100}, {92, 100}, {0, 0}, ptr + 96 + 200 * 192, 200},
    };
